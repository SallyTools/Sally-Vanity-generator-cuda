// BIP39 English wordlist (2048 words). Generated; do not edit by hand.
// Source: bitcoin/bips bip-0039/english.txt
// SHA256(file) = 2f5eed53a4727b4bf8880d8f3f199efc90e58503646d9ff8eff3a2ed3b24dbda
// Each word <= 8 chars; stored null-terminated in a [2048][9] table.
#pragma once

// __device__ (not __constant__): word lookups are divergent across threads, so
// L2-cached global memory beats constant memory (which serialises divergent reads).
#if defined(__CUDACC__)
  #define BIP39_MEM __device__
#else
  #define BIP39_MEM
#endif

BIP39_MEM static const char BIP39_WORDS[2048][9] = {
